...
def get_report_results(account_id, report_id, run_id,
                            token_id, token_password, file_type):
...
def get_report_result_as_pdf(account_id, report_id, run_id,
                            token_id, token_password):
    mode_api_base = f"https://app.mode.com/api/{account_id}"
    pdf_data_url = mode_api_base + "/reports/{report_id}/exports/runs/{run_id}/pdf/download"
    headers = {
      'Content-Type': 'application/json',
      'Accept': 'application/hal+json'
    }
...
def main():
    ...
    result = get_report_results(account_id, report_id, run_id,
                            token_id, token_password, file_type)
